...
def call_model(state: GraphState):
    ...
    system_prompt = SystemMessage(
        content=(
            ...
            "Las salidas/outputs de tus tools/herramientas son extensas, nunca mostrar estas salidas. "
            "Cuando vayas a trabajar (llamar tools) o estes trabajando (llamando tools) manda un mensajo muy breve, como por ejemplo 'Trabajando en el ranking o SLA, etc., espera un momento por favor.' ejemplo: 'ahora voy a calcular, etc....' "
            ...
            f"Siempre considera las oficinas seleccionadas: {state['oficinas'] if state['oficinas'] else 'No hay seleccionadas, pedir al usuario que seleccione'}. "
            ...
            f"Considera todas las oficinas y este contexto de disponibilidad de datos para responder las preguntas: {contexto}, siempre considera llamar tools/herramientas si es necesario. "
            ...
            f"Internamente Siempre CONSIDERA la oficinas seleccionadas: {state['oficinas'] if state['oficinas'] else 'No hay seleccionadas, pedir al usuario que seleccione'}. "
            "*IMPORTANTE*: Cuando el usuario proporciona un periodo/rango de tiempo  (por ejemplo, 'ayer', 'última semana', o 'algún mes'), SIEMPRE debes usarlo directamente para responder. "
            "*IMPORTANTE*: SOLO Si el usuario NO proporciona un periodo (por ejemplo, ayer, última semana, o algún mes), debes preguntarle con AskHuman el periodo/rango de tiempo a reportar"
            ...
            "Si hay algún error, solo tienes que decir: hubo un inconveniente en la obtención de los datos, intente nuevamente por favor."
